...
static const int64 nTargetTimespan = 60 * 5; // 10.5 minutes
static const int64 nTargetSpacing = 60; // 2.1 minutes
...
{
        static const int64 BlocksTargetSpacing = 9; // 9 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
        ...
        if (TestNet()) {
                ...
                if (pindexLast->nHeight+1 >= 1500) { DiffMode = 2; }//kgw s on b 100
        }
